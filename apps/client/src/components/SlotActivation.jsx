...
const SlotActivation = () => {
    return (
        <div className="flex-1 -m-8 flex flex-col overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-900 via-background-dark to-background-dark">
            {/* Header / Sub-header for Slot Activation */}
            <div className="px-8 py-6 border-b border-white/10 flex items-center justify-between bg-primary/50 backdrop-blur-md">
                <div className="flex items-center gap-4">
                    <h2 className="text-lg font-semibold tracking-tight">Slot Activation</h2>
                    <div className="h-4 w-[1px] bg-white/10 mx-2"></div>
                    <div className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/5">
                        <span className="material-symbols-outlined text-xs text-accent-gold">stars</span>
                        <span className="text-xs font-bold text-zinc-300">Orbitals Phase 2</span>
                    </div>
                </div>
                <div className="flex items-center gap-6">
                    <div className="flex gap-2">
                        <div className="px-4 py-2 bg-white/5 rounded-lg border border-white/5 flex flex-col items-end">
                            <span className="text-[10px] text-zinc-500 leading-none lowercase">TOTAL IGT</span>
                            <span className="text-sm font-bold leading-tight">5,240.00</span>
                        </div>
                        <div className="px-4 py-2 bg-white/5 rounded-lg border border-white/5 flex flex-col items-end">
                            <span className="text-[10px] text-zinc-500 leading-none lowercase">TOTAL CES</span>
                            <span className="text-sm font-bold leading-tight">1,200.50</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-8">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-10">
                        <h1 className="text-4xl font-black tracking-tighter mb-2 uppercase">Activation Orbitals</h1>
                        <p className="text-zinc-400 max-w-xl">Unlock higher planetary dimensions to multiply your rewards and access premium governance protocols.</p>
                    </div>
                        ...
                        <div className="glass-card rounded-xl p-6 relative overflow-hidden group border-accent-purple/30">
                            ...
                            <div className="flex flex-col items-center mb-6 pt-4">
                                <div className="orbital-container">
                                    ...
                                    <div className="w-12 h-12 rounded-full glow-purple flex items-center justify-center">
                                        <span className="material-symbols-outlined text-white text-xl">rocket_launch</span>
                                    </div>
                                    <div className="planet h-3 w-3 top-[10px] left-[50px] glow-gold"></div>
                                    <div className="planet h-2 w-2 bottom-[30px] right-[10px] bg-zinc-400"></div>
                                </div>
                            </div>
            ...
            {/* Sticky Footer Info */}
            <footer className="bg-primary/80 backdrop-blur-md border-t border-white/10 px-8 py-3 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Active Slot Reward</span>
                        <span className="text-xs font-black text-accent-purple">+12.5% APY</span>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <p className="text-[10px] font-medium text-zinc-500 uppercase">TRANSACTION FEES: 0.002 SOL</p>
                    <button className="bg-white/5 hover:bg-white/10 text-[10px] font-bold px-3 py-1.5 rounded border border-white/5 transition-colors">
                        REFRESH DATA
                    </button>
                </div>
            </footer>
